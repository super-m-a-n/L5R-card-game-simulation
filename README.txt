...
Αναπαραστάσεις δεδομένων- Παραδοχές- Αιτιολογήσεις σχεδιαστικών επιλογών
    ...
    3. Player.hpp/ Player.cpp
        ...
        • equipPhase :
            ...
            Επιπλέον, δίνεται η δυνατότητα στον παίχτη να κάνει tap κάποια από τα holdings του ,αν έχει ,για παραπάνω χρήματα στο round. Απο αυτά τα παραπάνω χρήματα όσα δεν χρησιμοποιηθούν για αγορά, θεωρούνται χαμένα χρήματα και αφαιρούνται από τον παίχτη στο τέλος της φάσης. Για αυτό τον σκοπό ,
            θεωρήθηκε ένα επιπλέον data member του player το roundMoney το οποίο αντιστοιχεί στο ποσό των χρημάτων του παίχτη στην αρχή του γύρου.
            Στο τέλος κάθε φάσης που εμπεριέχει αγορές (εξοπλισμού και αγορών) , γίνεται σύγκριση του money με το roundMoney για να διαπιστωθεί αν χρήματα από
            το tapping των holdings εμειναν ενεκμετάλλευτα (money > roundMoney) και τοτε αφαιρούνται από το ποσό των χρημάτων του παίχτη (money = roundMoney).
            Κάθε φορά που πρέπει να γίνει μια απόφαση για τον παίχτη, (πχ έλεγχος χρημάτων, έλεγχος προϋποθέσεων για μια αγορά), έχουν τυπωθεί οι αντίστοιχες κάρτες ήδη στην οθόνη με τα κατάλληλα πεδία.
        ...
        • battlePhase:
           Αρχικά, ο παίχτης επιλέγει πόσες untapped Personalities από το Army θα είναι στο Arena για defense/battle και ποιες από αυτές συγκεκριμένα (πρέπει να επιλέξει διαφορετικές κάρτες από το Army). Εκτυπώνεται το Army για να γίνουν οι επιλογές. Επαναπροσδιορίζεται η Arena οπότε και καταστρέφεται η προηγούμενη. Η Arena είναι ένα vector από integers που κάθε integer είναι ένα index στο vector Army. Εκτυπώνεται η Arena. Αν ο παίχτης έχει διαλέξει Battle, εκτυπώνονται οι επαρχίες του αντιπάλου που έχει επιλέξει από το gameplay και διαλέγει μια επαρχία να επιτεθεί. Η arena του αντιπάλου είναι αυτή που έχει διαμορφώσει από προηγούμενο γύρο. Υπολογίζονται οι συνολικοί πόντοι του επιτιθέμενου και του αμυνόμενου. Η άμυνα της επαρχίας είναι το initialDefense του Stronghold. Εκτυπώνονται οι πόντοι. Η διαδικασία χωρίζεται σε περιπτώσεις όπως ορίζει η εκφώνηση. Στο τέλος κάθε περίπτωσης, εκτυπώνεται αντίστοιχο μήνυμα. Στην περίπτωση που ο επιτιθέμενος επιζήσει αλλά δεν έχει βγει νικητής, οι προσωπικότητες και οι ακόλουθοί τους γίνονται tap και τα αντικείμενα χάνουν ένα durability. Οι επιζήσαντες προσωπικότητες χάνουν έναν πόντο εντιμότητας. Εκτυπώνεται η Arena του επιτιθέμενου και του αμυνόμενου, δηλαδή οι επιζήσαντες προσωπικότητες με τα νέα δεδομένα.
